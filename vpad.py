...
def change_font_color():
    ...
    # print(color_var) isme foreground ke liye index 1 lenge
...
edit.add_command(label='Clear_all',image=clear_all_icon,compound=tk.LEFT,accelerator='Ctrl+Alt+X', command=lambda:text_editor.event_delete(1.0,END))
